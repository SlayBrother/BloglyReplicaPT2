...
@app.route ('/posts/<int:user_id>/posts/new')
def posts_new_form(user_id):
    """Show create new post form for user"""
...
def posts_update(post_id):
    """Handle existing form edit submissions"""
    post=Post.query.get_or_404(post_id)
